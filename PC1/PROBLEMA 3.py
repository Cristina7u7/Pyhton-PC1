...
peso_payaso=112
peso_muñeca=75
payasos=float(input("Ingrese la cantidad de cuántos payasos desea:"))
muñecas=float(input("Ingrese la cantidad de cuántas muñecas desea:"))
peso_total=(payasos*peso_payaso+muñecas*peso_muñeca)/1000
print(f"El peso total del paquete enviado será: {peso_total}kg")
